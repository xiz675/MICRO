...
MATCH (person:Person)-[:LIKES]->(post:Post)-[:HAS_TAG]->(tag:Tag)-[:IS_SUBCLASS_OF]->(tagClass:TagClass)
WHERE person.email = $param AND tagClass.name = $param
RETURN person.firstName, person.lastName, post.id, tag.name, tagClass.name;
```cypher
...
MATCH (p1:Person)-[:KNOWS]->(p2:Person)-[:HAS_CREATOR]->(msg:Message)-[:IS_LOCATED_IN]->(city:City)
WHERE p1.locationIP = $param AND city.name = $param
RETURN p1.firstName, p2.firstName, msg.content, city.name;
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(country:Country)<-[:IS_LOCATED_IN]-(msg:Message)
WHERE p.gender = $param AND country.name = $param
RETURN p.firstName, u.name, country.name, msg.content;
...
MATCH (country:Country)<-[:IS_PART_OF]-(city:City)<-[:IS_LOCATED_IN]-(msg:Message)-[:HAS_CREATOR]->(p:Person)
WHERE country.name = $param AND msg.creationDate > datetime($param)
RETURN country.name, city.name, msg.content, p.firstName;
```
...
MATCH (person:Person)-[:WORK_AT]->(company:Company)-[:IS_LOCATED_IN]->(city:City)-[:IS_PART_OF]->(country:Country) 
WHERE country.name = $param AND person.speaks = $param 
RETURN person.firstName, person.lastName, company.name, city.name, country.name;
...
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(ct:City)
WHERE p.birthday < $param AND ct.name = $param
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(c:Country)
WHERE p.gender = $param AND c.name = $param
RETURN p.id, p.firstName, p.lastName, u.name;
...
7. MATCH (p:Person)-[:HAS_INTEREST]->(t:Tag)<-[:HAS_TAG]-(m:Message)-[:IS_LOCATED_IN]->(pl:Place)
   WHERE t.name = $param AND pl.name = $param
   RETURN p.firstName, p.lastName, m.content, t.name, pl.name;

8. MATCH (p:Person)-[:HAS_CREATOR]->(c:Comment)-[:REPLY_OF]->(m:Message)-[:CONTAINER_OF]->(f:Forum)
   WHERE p.browserUsed = $param AND f.title CONTAINS $param
   RETURN p.firstName, p.lastName, c.content, m.content, f.title;

9. MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(ct:City)<-[:IS_PART_OF]-(co:Country)
   WHERE c.name = $param AND co.name = $param
   RETURN p.firstName, p.lastName, c.name, ct.name, co.name;

10. MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(pl:Place)
...
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(city:City)-[:IS_PART_OF]->(country:Country) 
WHERE p.lastName = $param AND country.name = $param 
RETURN p.firstName, p.lastName, c.name, city.name;
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(country:Country)<-[:IS_PART_OF]-(city:City)
WHERE u.name = $param AND city.name = $param 
RETURN p.firstName, p.lastName, u.name, country.name;
...
MATCH (p:Person)-[:LIKES]->(post:Post)-[:HAS_TAG]->(:Tag)-[:IS_SUBCLASS_OF]->(t:TagClass) 
WHERE t.name = $param AND p.email = $param
...
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(ct:City)
WHERE p.gender = $param AND c.name = $param
RETURN p.firstName, p.lastName, ct.name;
...
MATCH (m:Message)-[:REPLY_OF*1..2]->(org:Message)-[:HAS_CREATOR]->(person:Person)
WHERE m.content CONTAINS $param AND person.gender = $param
RETURN m.id, org.id, person.firstName, person.lastName;

MATCH (u:University)-[:IS_LOCATED_IN]->(country:Country)<-[:IS_PART_OF]-(place:Place)<-[:IS_LOCATED_IN]-(org:Organisation)
WHERE u.name = $param AND country.name = $param
RETURN u.name, org.name, place.name;
...
MATCH (p:Person)-[:STUDY_AT]->(uni:University)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(msg:Message)
WHERE p.birthday > $param AND msg.creationDate < $param
RETURN p.firstName, p.lastName, uni.name, msg.content;
...
MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(city:City)
WHERE p.locationIP = $param AND city.name = $param
RETURN c.id, c.name, city.name;

MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(country:Country)<-[:IS_PART_OF]-(continent:Continent)
WHERE p.speaks CONTAINS $param AND continent.name = $param
RETURN u.id, u.name, country.name;
...
MATCH (p:Person)-[:HAS_MEMBER]->(f:Forum)-[:CONTAINER_OF]->(c:Comment)-[:REPLY_OF*1..2]->(m:Message)
WHERE p.locationIP = $param AND f.title = $param
RETURN c.id, c.content, m.id, m.content;
...
MATCH (p:Person)-[:STUDY_AT]->(uni:University)-[:IS_LOCATED_IN]->(country:Country)<-[:IS_LOCATED_IN]-(msg:Message)
WHERE uni.name = $param AND msg.length < $param
RETURN p.firstName, p.lastName, msg.content;

MATCH (p:Person)-[:HAS_CREATOR]-(msg:Message)-[:REPLY_OF*1..3]->(orgMsg:Message)-[:HAS_TAG]->(tag:Tag)
WHERE msg.creationDate < $param AND tag.name = $param
RETURN p.firstName, p.lastName, msg.content, orgMsg.id;
...
MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:WORK_AT]->(company:Company)-[:IS_LOCATED_IN]->(city:City)
WHERE friend.gender = $param AND city.name = $param
RETURN p.firstName, p.lastName, company.name;
```
...
MATCH (org:Organisation)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(msg:Message)-[:HAS_CREATOR]->(p:Person)
WHERE city.name = $param AND org.name STARTS WITH $param
RETURN org.name, city.name, msg.content, p.firstName;
...
1. MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:HAS_INTEREST]->(t:Tag)<-[:HAS_TAG]-(msg:Message)
   WHERE p.gender = $param AND friend.birthday > date($param)
   RETURN msg.content, msg.creationDate, friend.firstName, friend.lastName;

2. MATCH (org:Organisation)-[:IS_LOCATED_IN]->(city:City)<-[:IS_PART_OF]-(country:Country)<-[:IS_PART_OF]-(continent:Continent)
   WHERE org.name = $param AND country.name = $param
   RETURN org.id, org.name, city.name, continent.name;

3. MATCH (p:Person)-[:WORK_AT]->(comp:Company)-[:IS_LOCATED_IN]->(place:Place)<-[:IS_LOCATED_IN]-(msg:Message)
...
4. MATCH (post:Post)-[:HAS_CREATOR]->(p:Person)-[:STUDY_AT]->(uni:University)-[:IS_LOCATED_IN]->(city:City)
   WHERE post.length > $param AND p.email = $param
   RETURN post.id, post.content, p.firstName, p.lastName, uni.name, city.name;

5. MATCH (tag:Tag)-[:HAS_TYPE]->(tc:TagClass)-[:IS_SUBCLASS_OF]->(parentTc:TagClass)
   WHERE tag.name = $param AND tc.name = $param
   RETURN tag.id, tag.name, tc.name, parentTc.name;

6. MATCH (forum:Forum)-[:HAS_MEMBER]->(p:Person)-[:KNOWS]->(friend:Person)-[:HAS_CREATOR]->(cmt:Comment)
...
7. MATCH (p:Person)-[:LIKES]->(msg:Message)-[:HAS_TAG]->(tag:Tag)-[:HAS_TYPE]->(tc:TagClass)
   WHERE p.birthday < date($param) AND msg.length > $param
   RETURN p.id, p.firstName, p.lastName, msg.content, tag.name, tc.name;

8. MATCH (cmt:Comment)-[:REPLY_OF]->(msg:Message)-[:HAS_CREATOR]->(creator:Person)-[:HAS_INTEREST]->(tag:Tag)
...
9. MATCH (p:Person)-[:IS_LOCATED_IN]->(city:City)-[:IS_PART_OF]->(country:Country)<-[:IS_LOCATED_IN]-(org:Organisation)
   WHERE p.speaks = $param AND org.name = $param
   RETURN p.id, p.firstName, p.lastName, city.name, country.name, org.id, org.name;

10. MATCH (msg:Message)-[:HAS_TAG]->(tag:Tag)<-[:HAS_TAG]-(forum:Forum)-[:HAS_MODERATOR]->(mod:Person)
    WHERE msg.browserUsed = $param AND tag.name = $param
    RETURN msg.id, msg.content, forum.title, mod.id, mod.firstName, mod.lastName;
MATCH (p:Person)-[:KNOWS]->(p2:Person)-[:HAS_CREATOR]->(m:Message)-[:HAS_TAG]->(t:Tag)-[:HAS_TYPE]->(tc:TagClass {name: $param}) 
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(c:City)<-[:IS_LOCATED_IN]-(m:Message)-[:HAS_CREATOR]->(p2:Person) 
WHERE c.name = $param AND p.gender = $param 
RETURN p.firstName, p.lastName, u.name, c.name, m.content, p2.firstName, p2.lastName;

MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(city:City)<-[:IS_PART_OF]-(country:Country)<-[:IS_PART_OF]-(continent:Continent) 
WHERE continent.name = $param AND c.name = $param 
RETURN p.firstName, p.lastName, c.name, city.name, country.name, continent.name;
...
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(u:University)<-[:STUDY_AT]-(student:Person)
WHERE p.gender = $param AND city.name = $param
RETURN p.id, p.firstName, p.lastName, c.name, student.id, student.firstName, student.lastName, u.name;
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(o:Organisation)<-[:HAS_CREATOR]-(m:Message)
WHERE p.gender = $param AND m.length > $param
RETURN p.id, p.firstName, p.lastName, u.name, city.id, city.name, o.id, o.name, m.id, m.content;
...
MATCH (p:Person)-[:LIKES]->(post:Post)-[:HAS_TAG]->(tag:Tag)-[:IS_SUBCLASS_OF*1..2]->(tc:TagClass)
WHERE post.browserUsed = $param AND tc.name = $param
RETURN p.id, p.firstName, p.lastName, post.id, post.content, tag.id, tag.name, tc.id, tc.name;
...
```
1. MATCH (p:Person)-[:KNOWS]-(friend:Person)-[:HAS_CREATOR]->(m:Message) WHERE p.gender = $param AND friend.birthday > $param RETURN friend.firstName, friend.lastName, m.content;

2. MATCH (p:Person)-[:HAS_INTEREST]->(t:Tag)<-[:HAS_TAG]-(msg:Message)-[:IS_LOCATED_IN]->(place:Place) WHERE t.name = $param AND place.name = $param RETURN msg.content, msg.creationDate, p.firstName, p.lastName;

3. MATCH (org:Organisation)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(univ:University)<-[:STUDY_AT]-(p:Person) WHERE city.name = $param AND org.name = $param RETURN org.name, univ.name, p.firstName, p.lastName;

4. MATCH (f:Forum)-[:HAS_MEMBER]->(p:Person)-[:HAS_CREATOR]->(msg:Message)-[:REPLY_OF]->(orig:Message) WHERE f.title = $param AND orig.creationDate > $param RETURN p.firstName, p.lastName, msg.content;

5. MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(country:Country) WHERE p.birthday < $param AND country.name = $param RETURN p.firstName, p.lastName, c.name;

6. MATCH (tc:TagClass)<-[:HAS_TYPE]-(t:Tag)<-[:HAS_TAG]-(post:Post)<-[:CONTAINER_OF]-(f:Forum) WHERE tc.name = $param AND f.creationDate < $param RETURN f.title, post.content, t.name;

7. MATCH (c:Comment)-[:REPLY_OF]->(post:Post)-[:HAS_TAG]->(tag:Tag)<-[:HAS_TYPE]-(tc:TagClass) WHERE c.length > $param AND tc.name = $param RETURN post.content, c.content, tag.name;

8. MATCH (person:Person)-[:LIKES]->(msg:Message)-[:IS_LOCATED_IN]->(c:City)<-[:IS_LOCATED_IN]-(uni:University) WHERE c.name = $param AND uni.name = $param RETURN person.firstName, person.lastName, msg.content;

9. MATCH (p:Person)-[:HAS_MODERATOR]->(f:Forum)-[:CONTAINER_OF]->(m:Message)<-[:REPLY_OF]-(c:Comment) WHERE p.email ENDS WITH $param AND m.creationDate > $param RETURN f.title, m.content, c.content;

10. MATCH (p1:Person)-[:KNOWS]-(p2:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(place:Place) WHERE p1.gender = $param AND place.name = $param RETURN p1.firstName, p1.lastName, p2.firstName, p2.lastName, u.name;
```cypher
MATCH (p:Person)-[:HAS_INTEREST]->(t:Tag)<-[:HAS_TAG]-(m:Message)-[:REPLY_OF]->(c:Comment)-[:HAS_CREATOR]->(p2:Person)
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(country:Country)<-[:IS_PART_OF]-(continent:Continent)
WHERE p.speaks = $param AND continent.name = $param
RETURN p.firstName, u.name, country.name, continent.name;
...
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(city:City)<-[:IS_PART_OF]-(country:Country)
WHERE p.locationIP = $param AND city.name = $param
RETURN p.firstName, c.name, city.name, country.name;
```
...
MATCH (person:Person)-[:WORK_AT]->(company:Company)-[:IS_LOCATED_IN]->(city:City {name: $param})<-[:IS_LOCATED_IN]-(message:Message) 
WHERE person.gender = $param AND message.creationDate > datetime($param) 
RETURN person.firstName, person.lastName, company.name, message.content; 
...
MATCH (person:Person)-[:HAS_MODERATOR]->(forum:Forum)-[:CONTAINER_OF]->(post:Post)<-[:REPLY_OF]-(comment:Comment {id: $param}) 
RETURN person.firstName, person.lastName, forum.title, post.content, comment.content; 

MATCH (person:Person)-[:HAS_INTEREST]->(tag:Tag)<-[:HAS_TAG]-(message:Message)-[:IS_LOCATED_IN]->(city:City) 
WHERE city.name = $param AND message.browserUsed = $param 
RETURN person.firstName, person.lastName, tag.name, message.content;
...
MATCH (p1:Person)-[:REPLY_OF]->(m:Message)<-[:HAS_CREATOR]-(p2:Person)
WHERE p1.birthday < date($param) AND p2.birthday > date($param)
...
1. MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:HAS_INTEREST]->(t:Tag)-[:HAS_TYPE]->(tc:TagClass) WHERE friend.firstName = $param RETURN p.firstName, p.lastName, tc.name;

2. MATCH (c:Comment)-[:REPLY_OF*]->(origPost:Post)<-[:CONTAINER_OF]-(f:Forum) WHERE f.title = $param RETURN c.content, c.creationDate;

3. MATCH (p:Person)-[:WORK_AT]->(org:Organisation)-[:IS_LOCATED_IN]->(city:City) WHERE org.name = $param AND city.name = $param RETURN p.firstName, p.lastName, org.name, city.name;

4. MATCH (msg:Message)-[:HAS_TAG]->(tag:Tag)<-[:HAS_TAG]-(relatedMsg:Message) WHERE msg.creationDate > $param RETURN msg.content, relatedMsg.content;

5. MATCH (p:Person)-[:STUDY_AT]->(uni:University)-[:IS_LOCATED_IN]->(country:Country) WHERE uni.name = $param RETURN p.firstName, p.lastName, country.name;

6. MATCH (p:Person)-[:LIKES]->(post:Post)-[:HAS_CREATOR]->(author:Person) WHERE author.gender = $param RETURN p.firstName, p.lastName, post.content, author.firstName, author.lastName;

7. MATCH (f:Forum)-[:HAS_MEMBER]->(p:Person)-[:HAS_INTEREST]->(t:Tag) WHERE f.title = $param RETURN p.firstName, p.lastName, t.name;

8. MATCH (c:Company)-[:IS_LOCATED_IN]->(place:Place)<-[:IS_LOCATED_IN]-(msg:Message) WHERE c.name = $param RETURN msg.content, msg.creationDate, place.name;

9. MATCH (p:Person)-[:HAS_CREATOR]->(msg:Message)-[:REPLY_OF*]->(origMsg:Message)<-[:HAS_CREATOR]-(origAuthor:Person) WHERE origAuthor.birthday < $param RETURN p.firstName, p.lastName, msg.content, origAuthor.firstName, origAuthor.lastName;

10. MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:WORK_AT]->(comp:Company)-[:IS_LOCATED_IN]->(city:City) WHERE city.name = $param RETURN p.firstName, p.lastName, friend.firstName, friend.lastName, comp.name, city.name;
...
MATCH (p1:Person)-[:KNOWS*2]-(p2:Person)-[:HAS_INTEREST]->(t:Tag)-[:IS_SUBCLASS_OF]->(tc:TagClass)
WHERE p1.email = $param AND tc.name = $param
RETURN p1, p2, t, tc;
...
1. MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:HAS_CREATOR]->(c:Comment)-[:REPLY_OF]->(m:Message)<-[:HAS_CREATOR]-(p2:Person) 
WHERE p.id = $param AND p2.gender = $param 
RETURN p.firstName, p.lastName, friend.firstName, friend.lastName, c.content;

2. MATCH (p:Person)-[:HAS_INTEREST]->(t:Tag)<-[:HAS_TAG]-(m:Message)-[:REPLY_OF]->(c:Comment)-[:HAS_CREATOR]->(person:Person) 
...
3. MATCH (f:Forum)-[:CONTAINER_OF]->(post:Post)-[:HAS_CREATOR]->(p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(c:City) 
WHERE f.title CONTAINS $param AND c.name = $param 
RETURN f.title, post.content, p.firstName, p.lastName, u.name, c.name;

4. MATCH (p:Person)-[:WORK_AT]->(comp:Company)-[:IS_LOCATED_IN]->(country:Country)<-[:IS_PART_OF]-(cont:Continent) 
WHERE comp.name = $param AND cont.name = $param 
RETURN p.firstName, p.lastName, comp.name, country.name, cont.name;

5. MATCH (m:Message)-[:HAS_TAG]->(tag:Tag)-[:HAS_TYPE]->(tc:TagClass)-[:IS_SUBCLASS_OF]->(parent:TagClass) 
WHERE tc.name = $param AND parent.id = $param 
RETURN m.content, tag.name, tc.name, parent.name;

6. MATCH (comment:Comment)-[:REPLY_OF]->(post:Post)<-[:HAS_CREATOR]-(p:Person)-[:LIKES]->(c:Comment) 
...
7. MATCH (p:Person)-[:HAS_MEMBER]->(f:Forum)-[:HAS_MODERATOR]->(mod:Person)-[:KNOWS]->(k:Person) 
...
8. MATCH (post:Post)-[:IS_LOCATED_IN]->(place:Place)<-[:IS_PART_OF]-(country:Country)<-[:IS_PART_OF]-(continent:Continent) 
WHERE place.name = $param AND continent.name = $param 
RETURN post.content, place.name, country.name, continent.name;

9. MATCH (p:Person)-[:HAS_CREATOR]->(comment:Comment)-[:REPLY_OF]->(msg:Message)-[:HAS_TAG]->(tag:Tag) 
WHERE p.speaks CONTAINS $param AND tag.name = $param 
RETURN p.firstName, p.lastName, comment.content, msg.content, tag.name;

10. MATCH (p:Person)-[:WORK_AT]->(o:Organisation)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(univ:University)<-[:STUDY_AT]-(student:Person) 
...
```
1. MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:HAS_CREATOR]->(post:Post)-[:HAS_TAG]->(t:Tag)<-[:HAS_TYPE]-(tc:TagClass)
   WHERE p.firstName = $param AND tc.name = $param
   RETURN post.content, post.creationDate;

2. MATCH (p:Person)-[:HAS_INTEREST]->(t:Tag)<-[:HAS_TAG]-(post:Post)-[:CONTAINER_OF]->(forum:Forum)
   WHERE p.gender = $param AND forum.creationDate > $param
   RETURN forum.title, post.content;

3. MATCH (person:Person)-[:STUDY_AT]->(uni:University)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(company:Company)<-[:WORK_AT]-(colleague:Person)
   WHERE person.email = $param AND colleague.birthday < $param
   RETURN colleague.firstName, colleague.lastName, company.name;

4. MATCH (msg:Message)-[:REPLY_OF]->(orig:Message)<-[:HAS_CREATOR]-(creator:Person)-[:WORK_AT]->(comp:Company)
   WHERE msg.creationDate > $param AND comp.name = $param
   RETURN msg.content, creator.firstName, creator.lastName;

5. MATCH (p:Person)-[:LIKES]->(post:Post)<-[:CONTAINER_OF]-(forum:Forum)-[:HAS_MEMBER]->(member:Person)-[:HAS_CREATOR]->(comment:Comment)
   WHERE p.gender = $param AND forum.title = $param
   RETURN member.firstName, member.lastName, comment.content;

6. MATCH (p:Person)-[:HAS_CREATOR]->(msg:Message)-[:REPLY_OF]->(com:Comment)-[:HAS_CREATOR]->(creator:Person)-[:STUDY_AT]->(uni:University)
   WHERE p.speaks = $param AND uni.name = $param
   RETURN com.content, creator.firstName, creator.lastName;

7. MATCH (post:Post)-[:HAS_TAG]->(t:Tag)<-[:HAS_INTEREST]-(person:Person)-[:KNOWS]->(friend:Person)-[:HAS_CREATOR]->(comment:Comment)
   WHERE t.name = $param AND comment.length > $param
   RETURN comment.content, friend.firstName, friend.lastName;

8. MATCH (p:Person)-[:WORK_AT]->(comp:Company)-[:IS_LOCATED_IN]->(country:Country)<-[:IS_LOCATED_IN]-(msg:Message)-[:HAS_CREATOR]->(creator:Person)
   WHERE country.name = $param AND msg.creationDate < $param
   RETURN msg.content, creator.firstName, creator.lastName;

9. MATCH (forum:Forum)-[:HAS_MODERATOR]->(moderator:Person)-[:LIKES]->(post:Post)-[:HAS_CREATOR]->(creator:Person)-[:HAS_INTEREST]->(tag:Tag)
   WHERE moderator.gender = $param AND tag.name = $param
   RETURN post.content, creator.firstName, creator.email;

10. MATCH (p:Person)-[:HAS_CREATOR]->(msg:Message)-[:REPLY_OF]->(orig:Post)-[:CONTAINER_OF]->(forum:Forum)-[:HAS_TAG]->(tag:Tag)
...
MATCH (person:Person)-[:STUDY_AT]->(university:University)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(msg:Message)
WHERE person.speaks = $param AND city.name = $param
RETURN person.firstName, university.name, city.name, msg.content;
...
WHERE p.firstName = $param AND u.name = $param AND c.name = $param
RETURN p.id, p.firstName, p.lastName, u.name, c.name;
...
MATCH (p:Person)-[:HAS_CREATOR]-(m:Message)-[:IS_LOCATED_IN]->(c:City) WHERE c.id = $param AND m.browserUsed = $param RETURN p.firstName, p.lastName, m.content, c.name; 

MATCH (c:Comment)-[:HAS_CREATOR]->(p:Person)-[:WORK_AT]->(org:Organisation)-[:IS_LOCATED_IN]->(c:Country) WHERE org.name = $param RETURN c.content, p.firstName, p.lastName, org.name, c.name;
```cypher
MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(loc:Place)
WHERE p.id = $param AND loc.name = $param
RETURN friend.firstName, friend.lastName, c.name, loc.name;
...
MATCH (u:University)<-[:STUDY_AT]-(p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(city:City)
WHERE u.name = $param AND city.name = $param
RETURN p.firstName, p.lastName, c.name, city.name;
...
MATCH (f:Forum)-[:HAS_MODERATOR]->(moderator:Person)-[:IS_LOCATED_IN]->(country:Country)
WHERE moderator.gender = $param AND country.name = $param
RETURN f.title, moderator.firstName, moderator.lastName, country.name;
```
```cypher
MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:HAS_CREATOR]->(m:Message)
WHERE p.firstName = $param AND m.creationDate > $param
...
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(city:City)
WHERE c.name = $param AND p.birthday < $param
RETURN p.firstName, p.email, city.name;
...
MATCH (p:Person)-[:STUDY_AT]->(o:Organisation)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(m:Message)
WHERE m.creationDate > $param
RETURN p.firstName, o.name, city.name, m.content;
...
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(city:City)
WHERE c.name = $param AND p.speaks = $param
RETURN p.firstName, p.lastName, c.name, city.name;

MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(country:Country)
WHERE u.name = $param AND p.email = $param
RETURN p.firstName, p.lastName, u.name, country.name;
...
MATCH (p:Person)-[:WORK_AT]->(o:Organisation)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(m:Message)
WHERE p.birthday < $param AND city.name = $param
RETURN p.firstName, p.lastName, o.name, m.content, city.name;
...
MATCH (c:Country)<-[:IS_LOCATED_IN]-(p:Person)-[:STUDY_AT]->(u:University)
WHERE c.name = $param AND p.gender = $param
RETURN c.name, p.firstName, p.lastName, u.name;
...
MATCH (p:Person)-[:WORK_AT]->(comp:Company)-[:IS_LOCATED_IN]->(c:City)<-[:IS_LOCATED_IN]-(m:Message)
WHERE p.speaks = $param AND c.name = $param
RETURN p.firstName, p.lastName, comp.name, m.content;
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(c:City)<-[:IS_LOCATED_IN]-(m:Message)
WHERE u.name = $param AND m.creationDate < $param
RETURN p.id, p.firstName, c.name, m.content;
...
MATCH (p:Person)-[:HAS_CREATOR]->(m:Message)-[:REPLY_OF]->(orig:Message)
WHERE p.browserUsed = $param AND orig.creationDate < $param
RETURN p.firstName, p.lastName, m.content, orig.content;
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(c:City)<-[:IS_LOCATED_IN]-(m:Message)
WHERE p.gender = $param AND m.creationDate > $param
RETURN p.firstName, p.lastName, u.name, c.name, m.content;
...
MATCH (p:Person)-[:WORK_AT]->(u:University)-[:IS_LOCATED_IN]->(:City)<-[:IS_LOCATED_IN]-(f:Forum)
WHERE p.creationDate > $param AND u.name = $param
RETURN p.firstName, p.lastName, u.name, f.title;
...
MATCH (p:Person)-[:HAS_MEMBER]->(f:Forum)-[:CONTAINER_OF]->(m:Message)-[:IS_LOCATED_IN]->(c:City)
WHERE p.locationIP = $param AND c.name = $param
RETURN p.firstName, p.lastName, f.title, m.content, c.name;
...
```
```cypher
MATCH (p:Person)-[:HAS_INTEREST]->(t:Tag)<-[:HAS_TAG]-(m:Message)-[:HAS_CREATOR]->(c:Comment)-[:REPLY_OF]->(msg:Message)
...
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(ci:City)-[:IS_PART_OF]->(co:Country)
WHERE p.locationIP ENDS WITH $param AND co.name = $param
RETURN p.firstName, c.name, ci.name, co.name;
...
MATCH (p:Person)-[:HAS_CREATOR]->(m:Message)-[:REPLY_OF]->(msg:Message)-[:HAS_CREATOR]->(cre:Person)
WHERE p.gender = $param AND cre.email CONTAINS $param
RETURN p.firstName, m.content, cre.firstName, msg.content;
...
MATCH (person:Person)-[:WORK_AT]->(company:Company)-[:IS_LOCATED_IN]->(city:City)
WHERE person.speaks = $param AND city.name = $param
...
1. MATCH (p1:Person)-[:KNOWS]->(p2:Person)-[:LIKES]->(m:Message)-[:HAS_TAG]->(t:Tag)-[:HAS_TYPE]->(tc:TagClass) WHERE p1.firstName = $param AND tc.name = $param RETURN p2.id, p2.firstName, m.content, t.name;

2. MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(c:City)-[:IS_PART_OF]->(co:Country) WHERE p.birthday < $param AND co.name = $param RETURN p.firstName, p.lastName, u.name, c.name;

3. MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(pl:Place)-[:IS_PART_OF]->(co:Country) WHERE p.speaks = $param AND co.name = $param RETURN p.firstName, p.lastName, c.name, pl.name;

4. MATCH (f:Forum)-[:CONTAINER_OF]->(m:Message)-[:HAS_CREATOR]->(p:Person)-[:IS_LOCATED_IN]->(ci:City)-[:IS_PART_OF]->(co:Country) WHERE f.creationDate > $param AND p.gender = $param RETURN f.title, m.content, p.firstName, ci.name;

5. MATCH (m1:Message)-[:REPLY_OF]->(m2:Message)-[:HAS_CREATOR]->(p:Person)-[:KNOWS]->(p2:Person) WHERE m1.creationDate > $param AND p2.locationIP = $param RETURN m1.content, m2.content, p.firstName, p2.firstName;

6. MATCH (p:Person)-[:HAS_INTEREST]->(t:Tag)-[:HAS_TYPE]->(tc:TagClass)-[:IS_SUBCLASS_OF]->(tc2:TagClass) WHERE p.email = $param AND tc2.name = $param RETURN p.firstName, p.lastName, tc.name, tc2.name;

7. MATCH (c:Comment)-[:HAS_CREATOR]->(p:Person)-[:LIKES]->(m:Message)-[:HAS_TAG]->(t:Tag) WHERE c.creationDate < $param AND t.name = $param RETURN c.content, p.firstName, m.content, t.name;

8. MATCH (p:Person)-[:WORK_AT]->(o:Organisation)-[:IS_LOCATED_IN]->(ci:City) WHERE p.browserUsed = $param AND ci.name = $param RETURN p.firstName, p.lastName, o.name, ci.name;

9. MATCH (f:Forum)-[:HAS_MEMBER]->(p:Person)-[:HAS_INTEREST]->(t:Tag) WHERE f.title = $param AND t.name = $param RETURN f.title, p.firstName, p.lastName, t.name;

10. MATCH (p1:Person)-[:KNOWS]->(p2:Person)-[:HAS_CREATOR]->(m:Message)-[:IS_LOCATED_IN]->(pl:Place) WHERE p1.locationIP = $param AND pl.name = $param RETURN p1.firstName, p2.firstName, m.content, pl.name;
...
MATCH (p:Person)-[:KNOWS*3]->(f:Person) WHERE p.firstName = $param AND f.gender = $param RETURN f.id, f.firstName, f.lastName;  
...
```cypher
MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(city:City)
WHERE city.name = $param AND friend.gender = $param
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(country:Country)<-[:IS_PART_OF]-(continent:Continent)
WHERE continent.name = $param AND p.speaks CONTAINS $param
RETURN p.firstName, p.lastName, u.name, country.name;
...
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(u:University)
WHERE p.speaks CONTAINS $param AND city.name = $param
RETURN p.firstName, p.lastName, c.name, city.name, u.name;
...
MATCH (p1:Person)-[:LIKES]->(m:Message)<-[:HAS_CREATOR]-(p2:Person)-[:IS_LOCATED_IN]->(country:Country)
WHERE p1.gender = $param AND m.length > $param
RETURN p1.firstName, p1.lastName, m.id, m.content, p2.firstName, p2.lastName, country.name;

MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(country:Country)<-[:IS_LOCATED_IN]-(o:Organisation)<-[:WORK_AT]-(p2:Person)
WHERE u.name = $param AND o.name = $param
RETURN p.firstName, p.lastName, u.name, country.name, o.name, p2.firstName, p2.lastName;

MATCH (p:Person)-[:HAS_CREATOR]->(c:Comment)-[:REPLY_OF]->(m:Message)-[:HAS_TYPE]->(t:Tag)
WHERE t.name = $param AND c.creationDate < $param
RETURN p.firstName, p.lastName, c.id, c.content, m.id, m.content, t.name;
...
MATCH (msg:Message)-[:HAS_TAG]->(tag:Tag)-[:IS_SUBCLASS_OF]->(tc:TagClass)
WHERE msg.length > $param AND tc.name = $param
RETURN msg.content, tag.name, tc.name;
...
1. MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:HAS_INTEREST]->(tag:Tag)-[:HAS_TYPE]->(tagClass:TagClass {name: $param})
RETURN p.firstName, p.lastName, friend.firstName, friend.lastName, tag.name, tagClass.name;

2. MATCH (msg:Message)-[:REPLY_OF*2]->(post:Post)-[:HAS_CREATOR]->(creator:Person)
WHERE msg.creationDate > $param
RETURN msg.content, post.title, creator.firstName, creator.lastName;

3. MATCH (org:Organisation)-[:IS_LOCATED_IN]->(city:City)-[:IS_PART_OF]->(country:Country {name: $param})
RETURN org.name, city.name, country.name;

4. MATCH (cmt:Comment)-[:HAS_TAG]->(tag:Tag)<-[:HAS_TAG]-(post:Post)
WHERE cmt.creationDate < $param AND post.length > $param
RETURN cmt.content, post.content, tag.name;

5. MATCH (p:Person)-[:WORK_AT]->(company:Company)-[:IS_LOCATED_IN]->(country:Country)
WHERE p.birthday < $param AND country.name = $param
RETURN p.firstName, p.lastName, company.name, country.name;

6. MATCH (univ:University)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(person:Person)
WHERE person.gender = $param
RETURN univ.name, city.name, person.firstName, person.lastName;

7. MATCH (forum:Forum)-[:CONTAINER_OF]->(msg:Message)-[:HAS_CREATOR]->(creator:Person)
...
8. MATCH (p:Person)-[:STUDY_AT]->(univ:University)-[:IS_LOCATED_IN]->(place:Place)
WHERE p.email CONTAINS $param
RETURN p.firstName, p.lastName, univ.name, place.name;

9. MATCH (msg:Message)-[:HAS_TAG]->(tag:Tag)-[:HAS_TYPE]->(tagClass:TagClass)
WHERE msg.locationIP = $param
RETURN msg.content, tag.name, tagClass.name;

10. MATCH (person:Person)-[:HAS_CREATOR]-(msg:Message)<-[:REPLY_OF*]-(cmt:Comment)
...
MATCH (p:Person)-[:WORK_AT]->(company:Company)-[:IS_LOCATED_IN]->(city:City)
WHERE p.speaks = $param AND company.name = $param
RETURN p.firstName, p.lastName, city.name;
...
MATCH (p:Person)-[:LIKES]->(msg:Message)-[:HAS_CREATOR]->(creator:Person)-[:IS_LOCATED_IN]->(c:Country) 
WHERE c.name = $param AND msg.creationDate < $param 
RETURN creator.firstName, creator.lastName, msg.content;
...
RETURN person.firstName, person.lastName, post.content;
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(city:City)-[:IS_PART_OF]->(country:Country {name: $param})
WHERE p.birthday < $param
RETURN p.firstName, p.lastName, c.name, city.name, country.name;
...
MATCH (u:University)-[:IS_LOCATED_IN]->(city:City {name: $param})<-[:IS_LOCATED_IN]-(p:Person)-[:STUDY_AT]->(u)
WHERE p.speaks = $param
RETURN p.firstName, p.lastName, u.name, city.name;
...
MATCH (msg:Message)-[:REPLY_OF*1..3]->(original:Message)<-[:HAS_CREATOR]-(creator:Person)
WHERE msg.locationIP = $param AND creator.gender = $param
RETURN original.id, original.content, original.creationDate;
...
MATCH (f:Forum)-[:HAS_MEMBER]->(p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(city:City)
WHERE f.creationDate > $param AND city.name = $param
RETURN f.title, p.firstName, p.lastName, c.name, city.name;

MATCH (p:Person)-[:HAS_CREATOR]->(m:Message)-[:HAS_TAG]->(t:Tag)-[:HAS_TYPE]->(tc:TagClass)
WHERE m.creationDate < $param AND tc.name = $param
RETURN p.firstName, p.lastName, m.content, t.name, tc.name;

MATCH (u:University)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(c:Comment)-[:REPLY_OF]->(p:Post)
WHERE u.name = $param AND c.creationDate > $param
RETURN u.name, city.name, c.content, p.content;
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(c:City)<-[:IS_LOCATED_IN]-(m:Message)
WHERE p.locationIP = $param AND m.creationDate > $param
RETURN p.firstName, p.lastName, u.name, c.name, m.content; 
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(pl:Place)<-[:IS_LOCATED_IN]-(po:Post)
WHERE po.creationDate < $param AND u.name = $param
RETURN p.firstName, p.lastName, u.name, pl.name, po.content; 
...
MATCH (post:Post)-[:REPLY_OF]->(c:Comment)-[:HAS_CREATOR]->(p:Person)-[:IS_LOCATED_IN]->(country:Country)
WHERE post.length > $param AND country.name = $param
RETURN post.id, c.id, p.firstName, p.lastName, country.name;
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(m:Message)
WHERE m.length < $param AND city.name = $param
RETURN p.firstName, p.lastName, u.name, city.name, m.id;

MATCH (f:Forum)-[:HAS_MODERATOR]->(mod:Person)-[:KNOWS]->(p:Person)-[:REPLY_OF]->(m:Message)
WHERE f.title CONTAINS $param AND p.email ENDS WITH $param
RETURN f.title, mod.firstName, mod.lastName, p.firstName, p.lastName, m.id;

MATCH (p:Person)-[:WORK_AT]->(org:Organisation)-[:HAS_MEMBER]->(f:Forum)-[:CONTAINER_OF]->(post:Post)
WHERE post.creationDate < $param AND org.name = $param
RETURN p.firstName, p.lastName, org.name, f.title, post.id;
```
```cypher
MATCH (p:Person)-[:HAS_INTEREST]->(t:Tag)<-[:HAS_TAG]-(m:Message)-[:HAS_CREATOR]->(creator:Person)
...
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(cy:City)<-[:IS_PART_OF]-(co:Country)
WHERE co.name = $param AND p.gender = $param
RETURN p.firstName, p.lastName, c.name, cy.name, co.name;
...
MATCH (person:Person)-[:STUDY_AT]->(uni:University)-[:IS_LOCATED_IN]->(country:Country)
WHERE person.speaks = $param AND country.name = $param
RETURN person.firstName, person.lastName, uni.name, country.name;
...
MATCH (msg:Message)-[:HAS_TAG]->(t:Tag)-[:IS_SUBCLASS_OF]->(tc:TagClass)
WHERE msg.length > $param AND tc.name = $param
RETURN msg.id, msg.content, t.name, tc.name;
...
MATCH (msg1:Message)-[:REPLY_OF]->(msg2:Message)-[:CONTAINER_OF]->(f:Forum)<-[:HAS_MEMBER]-(person:Person)
WHERE msg1.content CONTAINS $param AND person.speaks = $param
RETURN msg1.id, msg1.content, msg2.id, f.title, person.firstName, person.lastName;
```
```cypher
MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:HAS_CREATOR]->(m:Message)
WHERE p.firstName = $param AND friend.birthday < $param
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(country:Country)
WHERE u.name = $param AND p.creationDate < $param
RETURN p.firstName, p.lastName, u.name, country.name;
...
1. MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(city:City)-[:IS_PART_OF]->(country:Country) WHERE p.gender = $param AND city.name = $param RETURN p.firstName, p.lastName, c.name, country.name;

2. MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:HAS_INTEREST]->(t:Tag)-[:HAS_TYPE]->(tc:TagClass) WHERE p.speaks = $param AND tc.name = $param RETURN p.firstName, p.lastName, friend.firstName, friend.lastName, t.name;

3. MATCH (c:Comment)-[:REPLY_OF*1..3]->(root:Post)-[:HAS_CREATOR]->(creator:Person) WHERE c.creationDate > $param AND creator.birthday < $param RETURN c.content, root.title, creator.firstName, creator.lastName;

4. MATCH (p:Post)-[:HAS_TAG]->(t:Tag)<-[:HAS_INTEREST]-(person:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(city:City) WHERE t.name = $param AND city.name = $param RETURN p.content, person.firstName, person.lastName, u.name;

5. MATCH (f:Forum)-[:CONTAINER_OF]->(m:Message)-[:HAS_TAG]->(t:Tag)-[:HAS_TYPE]->(tc:TagClass) WHERE f.creationDate > $param AND tc.name = $param RETURN f.title, m.content, t.name;

6. MATCH (p:Person)-[:LIKES]->(msg:Message)-[:HAS_CREATOR]->(creator:Person)-[:IS_LOCATED_IN]->(place:Place) WHERE p.locationIP = $param AND msg.length > $param RETURN p.firstName, p.lastName, msg.content, creator.firstName, creator.lastName, place.name;

7. MATCH (org:Organisation)<-[:WORK_AT]-(p:Person)-[:KNOWS]->(friend:Person)-[:LIKES]->(post:Post) WHERE org.name = $param AND post.creationDate > $param RETURN p.firstName, p.lastName, friend.firstName, friend.lastName, post.content;

8. MATCH (tc:TagClass)<-[:HAS_TYPE]-(t:Tag)<-[:HAS_TAG]-(msg:Message)<-[:REPLY_OF]-(c:Comment) WHERE c.creationDate > $param AND tc.name = $param RETURN t.name, msg.content, c.content;

9. MATCH (p:Person)-[:HAS_CREATOR]->(msg:Message)-[:IS_LOCATED_IN]->(place:Place)-[:IS_PART_OF]->(country:Country) WHERE p.browserUsed = $param AND country.name = $param RETURN p.firstName, p.lastName, msg.content, place.name;

10. MATCH (p:Person)-[:HAS_MODERATOR]->(f:Forum)-[:CONTAINER_OF]->(post:Post)-[:HAS_TAG]->(t:Tag) WHERE p.gender = $param AND t.name = $param RETURN p.firstName, p.lastName, f.title, post.content, t.name;
```cypher
MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:HAS_CREATOR]->(msg:Message)-[:HAS_TAG]->(tag:Tag)
WHERE p.firstName = $param AND tag.name = $param
...
MATCH (p:Person)-[:WORK_AT]->(comp:Company)-[:IS_LOCATED_IN]->(c:City)<-[:IS_PART_OF]-(country:Country)
WHERE p.birthday < $param AND country.name = $param
RETURN p.firstName, p.lastName, comp.name, c.name;

MATCH (p:Person)-[:STUDY_AT]->(uni:University)-[:IS_LOCATED_IN]->(place:Place)<-[:IS_PART_OF]-(continent:Continent)
WHERE p.speaks = $param AND continent.name = $param
RETURN p.firstName, p.lastName, uni.name, place.name;
...
MATCH (org:Organisation)-[:IS_LOCATED_IN]->(place:Place)<-[:IS_PART_OF]-(country:Country)
WHERE place.name = $param AND country.name = $param
RETURN org.name, place.name, country.name;
...
MATCH (msg:Message)-[:HAS_CREATOR]->(p:Person)-[:KNOWS]->(friend:Person)-[:HAS_TAG]->(tag:Tag)
WHERE msg.creationDate > $param AND tag.name = $param
RETURN msg.content, p.firstName, p.lastName, friend.firstName, friend.lastName, tag.name;
MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:HAS_CREATOR]->(m:Message)
WHERE p.gender = $param AND friend.birthday > $param
RETURN p.firstName, p.lastName, m.content;
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(cmp:Company)<-[:WORK_AT]-(colleague:Person)
WHERE p.gender = $param AND colleague.speaks CONTAINS $param
RETURN p.firstName, p.lastName, colleague.firstName, colleague.lastName;
MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:HAS_CREATOR]->(m:Message)-[:HAS_TAG]->(t:Tag)
WHERE p.locationIP = $param AND t.name = $param
RETURN p.firstName, p.lastName, m.content, t.name;
...
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(u:University)<-[:STUDY_AT]-(student:Person)
WHERE c.name = $param AND city.name = $param AND student.gender = $param
RETURN p.firstName, p.lastName, c.name, student.firstName, student.lastName;
...
MATCH (u:University)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(p:Person)-[:STUDY_AT]->(u)
WHERE city.name = $param AND p.birthday < $param
RETURN u.id, u.name, city.id, city.name, p.id, p.firstName, p.lastName;
...
MATCH (p:Person)-[:REPLY_OF]->(comment:Comment)-[:HAS_CREATOR]->(creator:Person {firstName: $param}), (comment)-[:HAS_TAG]->(tag:Tag) RETURN p.firstName, p.lastName, comment.content, tag.name;
MATCH (p:Person)-[:LIKES]->(msg:Message {id: $param})<-[:REPLY_OF]-(reply:Comment)-[:HAS_CREATOR]->(creator:Person) RETURN p.firstName, p.lastName, msg.content, reply.content, creator.firstName, creator.lastName;
MATCH (p:Person)-[:HAS_CREATOR]->(post:Post)-[:IS_LOCATED_IN]->(country:Country)<-[:IS_LOCATED_IN]-(org:Organisation {name: $param}) RETURN p.firstName, p.lastName, post.content, country.name, org.name;
```cypher
...
MATCH (person:Person)-[:STUDY_AT]->(university:University)-[:IS_LOCATED_IN]->(country:Country)<-[:IS_LOCATED_IN]-(message:Message)-[:HAS_CREATOR]->(creator:Person)
WHERE person.speaks = $param AND message.length > $param
RETURN person.firstName, person.lastName, university.name, creator.firstName, creator.lastName;
...
MATCH (org:Organisation)-[:IS_LOCATED_IN]->(:City {name: $param})<-[:IS_LOCATED_IN]-(msg:Message)
WHERE msg.length > $param AND org.name = $param
RETURN org.name, msg.content;
...
MATCH (msg:Message)-[:IS_LOCATED_IN]->(:Place {name: $param})<-[:IS_LOCATED_IN]-(:City)<-[:IS_LOCATED_IN]-(org:Organisation)
WHERE msg.creationDate > $param AND org.name = $param
RETURN msg.content, org.name;
```
```cypher
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(ci:City)
WHERE p.firstName = $param AND c.name = $param
RETURN p.id, p.firstName, p.lastName, c.name, ci.name;
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(msg:Message)
WHERE p.birthday < $param AND city.name = $param
RETURN p.id, p.firstName, u.name, city.name, msg.content;

MATCH (org:Organisation)<-[:WORK_AT]-(p:Person)-[:KNOWS]->(friend:Person)-[:LIKES]->(msg:Message)
WHERE org.name = $param AND msg.creationDate < $param
RETURN org.id, org.name, p.id, p.firstName, friend.id, friend.firstName, msg.content;

MATCH (tag:Tag)<-[:HAS_TAG]-(m:Message)<-[:HAS_CREATOR]-(p:Person)-[:IS_LOCATED_IN]->(country:Country)
WHERE tag.name = $param AND country.name = $param
RETURN tag.id, tag.name, m.id, m.content, p.id, p.firstName, country.name;
```
```cypher
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(ct:City)
WHERE p.gender = $param AND ct.name = $param
RETURN p.id, p.firstName, p.lastName, c.name, ct.name;
...
MATCH (p:Person)-[:STUDY_AT]->(:University)-[:IS_LOCATED_IN]->(ct:City)<-[:IS_LOCATED_IN]-(msg:Message)
WHERE msg.creationDate > $param
RETURN p.id, p.firstName, p.lastName, ct.name, msg.id, msg.content;
...
MATCH (msg1:Message)-[:REPLY_OF]->(msg2:Message)-[:HAS_CREATOR]->(creator:Person)-[:WORK_AT]->(comp:Company)
WHERE msg1.locationIP = $param AND comp.name = $param
RETURN msg1.id, msg1.content, msg2.id, msg2.content, creator.id, creator.firstName, creator.lastName, comp.id, comp.name;
```
...
MATCH (p:Person)-[:WORK_AT]->(comp:Company)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(uni:University)<-[:STUDY_AT]-(p2:Person)
WHERE p.gender = $param AND p2.speaks = $param
RETURN p.id, p.firstName, comp.name, city.name, uni.name, p2.id, p2.firstName;
...
MATCH (msg:Message)-[:HAS_CREATOR]->(creator:Person)-[:IS_LOCATED_IN]->(country:Country)<-[:IS_PART_OF]-(continent:Continent)
WHERE msg.length > $param AND country.name = $param
RETURN msg.id, msg.content, creator.firstName, country.name, continent.name;
...
```
1. MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:HAS_CREATOR]->(m:Message)-[:HAS_TAG]->(tag:Tag) WHERE p.firstName = $param AND tag.name = $param RETURN friend.id, m.content;

2. MATCH (p:Person)-[:HAS_INTEREST]->(tag:Tag)<-[:HAS_TAG]-(m:Message)-[:REPLY_OF]->(c:Comment)-[:HAS_CREATOR]->(author:Person) WHERE p.gender = $param AND author.birthday > $param RETURN m.id, c.content;

3. MATCH (org:Organisation)-[:IS_LOCATED_IN]->(city:City)<-[:IS_PART_OF]-(country:Country) WHERE org.name = $param AND country.name = $param RETURN city.id, city.name;

4. MATCH (f:Forum)-[:CONTAINER_OF]->(p:Post)-[:HAS_TAG]->(tag:Tag)<-[:HAS_TYPE]-(tagClass:TagClass) WHERE f.title CONTAINS $param AND tagClass.name = $param RETURN p.id, p.content;

5. MATCH (u:University)<-[:STUDY_AT]-(p:Person)-[:KNOWS]->(friend:Person)-[:WORK_AT]->(c:Company) WHERE u.name = $param AND c.name = $param RETURN p.firstName, friend.firstName, c.id;

6. MATCH (c:Comment)-[:REPLY_OF]->(m:Message)<-[:HAS_CREATOR]-(author:Person)-[:IS_LOCATED_IN]->(place:Place) WHERE c.creationDate > $param AND place.name = $param RETURN m.id, author.firstName;

7. MATCH (p:Post)-[:HAS_CREATOR]->(author:Person)-[:HAS_INTEREST]->(tag:Tag)<-[:HAS_TAG]-(m:Message) WHERE p.creationDate < $param AND tag.name = $param RETURN author.id, m.content;

8. MATCH (company:Company)<-[:WORK_AT]-(p:Person)-[:KNOWS]->(friend:Person)-[:HAS_CREATOR]->(m:Message)-[:IS_LOCATED_IN]->(city:City) WHERE company.name = $param AND city.name = $param RETURN friend.id, m.content;

9. MATCH (f:Forum)-[:HAS_MODERATOR]->(mod:Person)-[:HAS_CREATOR]->(m:Message)-[:HAS_TAG]->(tag:Tag) WHERE mod.gender = $param AND tag.name = $param RETURN m.id, f.title;

10. MATCH (t:Tag)<-[:HAS_TAG]-(p:Post)<-[:CONTAINER_OF]-(f:Forum)-[:HAS_MEMBER]->(person:Person) WHERE t.name = $param AND person.email CONTAINS $param RETURN p.id, f.title;
...
MATCH (p:Person)-[:STUDY_AT]->(uni:University)-[:IS_LOCATED_IN]->(country:Country {name: $param}) 
WHERE p.birthday < $param 
RETURN p.firstName, p.lastName, uni.name, country.name;
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(comp:Company)<-[:WORK_AT]-(p2:Person)
WHERE u.name = $param AND city.name = $param
RETURN p.firstName, p.lastName, p2.firstName, comp.name, city.name;
...
MATCH (message:Message)-[:HAS_TAG]->(tag:Tag)<-[:HAS_TYPE]-(relatedTag:Tag)
WHERE message.length > $param AND relatedTag.name = $param
RETURN message.id, message.content, tag.name;
...
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(city:City)-[:IS_PART_OF]->(country:Country)
WHERE p.email = $param AND country.name = $param
RETURN c.id, c.name, city.name, country.name;
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(m:Message)
WHERE p.speaks = $param AND m.creationDate < datetime($param)
RETURN p.id, p.firstName, p.lastName, u.name, city.name, m.content;
...
MATCH (p:Person)-[:WORK_AT]->(org:Organisation)-[:IS_LOCATED_IN]->(place:Place)<-[:IS_LOCATED_IN]-(c:Comment)
WHERE org.name = $param AND c.browserUsed = $param
RETURN p.id, p.firstName, p.lastName, org.id, org.name, place.name, c.content;
MATCH (p:Person)-[:HAS_CREATOR]->(m:Message)-[:HAS_TAG]->(t:Tag)-[:HAS_TYPE]->(tc:TagClass) 
WHERE tc.name = $param AND m.creationDate > $param 
RETURN p.firstName, p.lastName, m.content, t.name;
...
MATCH (m:Message)-[:HAS_TAG]->(t:Tag)-[:IS_SUBCLASS_OF]->(tc:TagClass) 
WHERE t.name = $param AND tc.name = $param 
RETURN m.content, m.creationDate, t.name, tc.name;
...
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(ci:City)
WHERE p.birthday < $param AND ci.name = $param
RETURN p.id, p.firstName, p.lastName, c.name, ci.name;
...
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(ct:City)
WHERE ct.name = $param AND p.gender = $param
RETURN p.firstName, p.lastName, p.email, c.name, ct.name;

MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(place:Place)<-[:IS_LOCATED_IN]-(m:Message)
WHERE p.speaks CONTAINS $param AND m.creationDate > $param
RETURN p.firstName, p.lastName, u.name, place.name, m.content;

MATCH (f:Forum)-[:HAS_MEMBER]->(member:Person)-[:HAS_CREATOR]->(msg:Message)-[:REPLY_OF]->(reply:Message)
WHERE f.title = $param AND msg.creationDate < $param
RETURN member.firstName, member.lastName, msg.content, reply.content;

MATCH (org:Organisation)<-[:WORK_AT]-(p:Person)-[:KNOWS]->(friend:Person)-[:HAS_INTEREST]->(t:Tag)
WHERE org.name = $param AND t.name = $param
RETURN p.firstName, p.lastName, friend.firstName, friend.lastName, t.name;

MATCH (p:Person)-[:LIKES]->(m:Message)-[:HAS_CREATOR]->(creator:Person)-[:IS_LOCATED_IN]->(c:Country)
WHERE c.name = $param AND p.birthday > $param
RETURN p.firstName, p.lastName, m.content, creator.firstName, creator.lastName, c.name;
...
MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:LIKES]->(post:Post)-[:IS_LOCATED_IN]->(place:Place)
WHERE friend.gender = $param AND place.name = $param
RETURN p.firstName, p.lastName, friend.firstName, friend.lastName, post.content, place.name;
...
MATCH (p:Person)-[:LIKES]->(msg:Post)-[:HAS_TAG]->(t:Tag)-[:IS_SUBCLASS_OF]->(tc:TagClass)
WHERE tc.name = $param AND p.locationIP = $param
RETURN p.firstName, p.lastName, msg.content, t.name, tc.name;
...
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(city:City)<-[:IS_PART_OF]-(country:Country {name: $param}) WHERE p.birthday < $param AND p.speaks CONTAINS $param RETURN p.firstName, p.lastName, c.name, city.name, country.name;
...
MATCH (person:Person)-[:WORK_AT]->(company:Company)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(university:University)<-[:STUDY_AT]-(student:Person)
WHERE person.birthday < $param AND city.name = $param
RETURN person.firstName, person.lastName, student.firstName, student.lastName;
...
MATCH (person:Person)-[:STUDY_AT]->(university:University)-[:IS_LOCATED_IN]->(country:Country)<-[:IS_PART_OF]-(continent:Continent)
WHERE person.speaks CONTAINS $param AND continent.name = $param
RETURN person.firstName, person.lastName, university.name, country.name;

MATCH (organisation:Organisation)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(msg:Message)-[:HAS_CREATOR]->(creator:Person)
WHERE organisation.name = $param AND msg.creationDate < $param
RETURN organisation.name, city.name, creator.firstName, creator.lastName, msg.content;
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(f:Forum)
WHERE p.gender = $param AND f.title = $param
RETURN p.firstName, p.lastName, u.name, city.name, f.title;
...
MATCH (m:Message)-[:REPLY_OF*1..3]->(original:Message)<-[:HAS_CREATOR]-(author:Person)
WHERE m.length > $param AND author.speaks CONTAINS $param
RETURN original.id, author.firstName, author.lastName;
...
MATCH (university:University)-[:IS_LOCATED_IN]->(country:Country)<-[:IS_PART_OF]-(continent:Continent) 
WHERE university.name = $param AND continent.name = $param 
RETURN university.id, university.name, country.name;
...
```
1. MATCH (p:Person)-[:HAS_CREATOR]->(m:Message)-[:HAS_TAG]->(t:Tag)-[:HAS_TYPE]->(tc:TagClass)
   WHERE p.gender = $param AND tc.name = $param
   RETURN p.firstName, p.lastName, m.content, t.name;

2. MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(c:City)-[:IS_PART_OF]->(co:Country)
   WHERE p.speaks = $param AND co.name = $param
   RETURN p.firstName, p.lastName, u.name, c.name;

3. MATCH (p1:Person)-[:KNOWS]->(p2:Person)-[:HAS_INTEREST]->(t:Tag)-[:HAS_TYPE]->(tc:TagClass)
   WHERE p1.birthday > $param AND tc.name = $param
   RETURN p1.firstName, p1.lastName, p2.firstName, p2.lastName, t.name;

4. MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(pl:Place)
   WHERE c.name = $param AND pl.name = $param
   RETURN p.firstName, p.lastName, c.name, pl.name;

5. MATCH (p:Person)-[:HAS_CREATOR]->(m:Message)-[:REPLY_OF]->(o:Message)-[:HAS_CREATOR]->(op:Person)
   WHERE m.creationDate > $param AND p.locationIP = $param
   RETURN p.firstName, p.lastName, op.firstName, op.lastName, m.content;

6. MATCH (f:Forum)-[:CONTAINER_OF]->(p:Post)-[:HAS_TAG]->(t:Tag)-[:HAS_TYPE]->(tc:TagClass)
   WHERE f.title = $param AND tc.name = $param
   RETURN f.title, p.content, t.name;

7. MATCH (p:Person)-[:HAS_MEMBER]->(f:Forum)-[:HAS_MODERATOR]->(mod:Person)
   WHERE p.email CONTAINS $param AND mod.gender = $param
   RETURN p.firstName, p.lastName, f.title, mod.firstName, mod.lastName;

8. MATCH (p:Person)-[:LIKES]->(c:Comment)-[:HAS_TAG]->(t:Tag)
   WHERE c.creationDate > $param AND t.name = $param
   RETURN p.firstName, p.lastName, c.content, t.name;

9. MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(pl:Place)
   WHERE friend.gender = $param AND pl.name = $param
   RETURN p.firstName, p.lastName, friend.firstName, friend.lastName, u.name;

10. MATCH (p:Person)-[:HAS_CREATOR]->(m:Message)-[:IS_LOCATED_IN]->(pl:Place)-[:IS_PART_OF]->(co:Country)
    WHERE m.browserUsed = $param AND co.name = $param
    RETURN p.firstName, p.lastName, m.content, pl.name, co.name;
1. MATCH (p:Person)-[:KNOWS]->(friend:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(place:Place) WHERE p.firstName = $param AND c.name = $param RETURN p.firstName, p.lastName, friend.firstName, friend.lastName, c.name, place.name;

2. MATCH (post:Post)-[:HAS_TAG]->(tag:Tag)-[:HAS_TYPE]->(tagClass:TagClass)-[:IS_SUBCLASS_OF]->(parentTagClass:TagClass) WHERE tagClass.name = $param RETURN post.content, tag.name, parentTagClass.name;

3. MATCH (person:Person)-[:HAS_INTEREST]->(tag:Tag)<-[:HAS_TAG]-(message:Message)-[:HAS_CREATOR]->(creator:Person) WHERE person.gender = $param AND creator.birthday < $param RETURN person.firstName, person.lastName, message.content, creator.firstName, creator.lastName;

4. MATCH (person:Person)-[:STUDY_AT]->(uni:University)-[:IS_LOCATED_IN]->(city:City)-[:IS_PART_OF]->(country:Country) WHERE uni.name = $param AND country.name = $param RETURN person.firstName, person.lastName, city.name;

5. MATCH (comment:Comment)-[:REPLY_OF]->(message:Message)-[:HAS_CREATOR]->(creator:Person) WHERE comment.creationDate > $param RETURN comment.content, message.content, creator.firstName, creator.lastName;

6. MATCH (person:Person)-[:LIKES]->(post:Post)-[:HAS_CREATOR]->(creator:Person)-[:WORK_AT]->(company:Company) WHERE person.birthday > $param AND company.name = $param RETURN person.firstName, person.lastName, post.content, creator.firstName, creator.lastName, company.name;

7. MATCH (forum:Forum)-[:CONTAINER_OF]->(post:Post)-[:HAS_TAG]->(tag:Tag)-[:HAS_TYPE]->(tagClass:TagClass) WHERE forum.creationDate < $param AND tagClass.name = $param RETURN forum.title, post.content, tag.name;

8. MATCH (person:Person)-[:WORK_AT]->(org:Organisation)-[:IS_LOCATED_IN]->(country:Country) WHERE person.speaks CONTAINS $param AND country.name = $param RETURN person.firstName, person.lastName, org.name, country.name;

9. MATCH (comment:Comment)-[:REPLY_OF]->(otherComment:Comment)<-[:REPLY_OF]-(otherComment2:Comment)-[:HAS_CREATOR]->(creator:Person) WHERE otherComment2.creationDate > $param RETURN comment.content, otherComment.content, otherComment2.content, creator.firstName, creator.lastName;

10. MATCH (person:Person)-[:HAS_MODERATOR]->(forum:Forum)-[:CONTAINER_OF]->(message:Message)-[:IS_LOCATED_IN]->(place:Place) WHERE person.gender = $param AND place.name = $param RETURN person.firstName, person.lastName, forum.title, message.content, place.name;
```cypher
MATCH (p:Person)-[:IS_LOCATED_IN]->(c:City)<-[:IS_LOCATED_IN]-(m:Message)
WHERE p.gender = $param AND c.name = $param
RETURN p.firstName, p.lastName, m.content, m.creationDate;
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(city:City)<-[:IS_LOCATED_IN]-(m:Message)
WHERE p.gender = $param AND city.name = $param
RETURN p.firstName, p.lastName, u.name, m.content;
...
MATCH (p:Person)-[:WORK_AT]->(c:Company)-[:IS_LOCATED_IN]->(country:Country)<-[:IS_PART_OF]-(continent:Continent)
WHERE p.birthDay > date($param) AND continent.name = $param
RETURN p.id, p.firstName, p.lastName, c.id, c.name, country.name;
...
MATCH (p:Person)-[:STUDY_AT]->(u:University)-[:IS_LOCATED_IN]->(pl:Place)<-[:IS_PART_OF]-(country:Country)
WHERE p.speaks CONTAINS $param AND country.name = $param
RETURN p.id, p.firstName, p.lastName, u.id, u.name, pl.name, country.name;
MATCH (p:Person)-[:KNOWS]-(friend:Person)-[:HAS_INTEREST]->(tag:Tag)<-[:HAS_TAG]-(post:Post)
WHERE p.id = $param AND post.creationDate > $param
RETURN friend.firstName, friend.lastName, post.content;
...
MATCH (comment:Comment)-[:REPLY_OF]->(post:Post)-[:HAS_CREATOR]->(creator:Person)-[:IS_LOCATED_IN]->(country:Country)
WHERE comment.browserUsed = $param AND country.name = $param
RETURN comment.content, post.content, creator.firstName, creator.lastName;
