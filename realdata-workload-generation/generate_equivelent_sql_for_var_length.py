...
from utils.sql_rewrite_util import rewrite_cm_queries_to_sql, remove_stars
...
if __name__ == '__main__':
    query_path = r"C:\Users\sauzh\Documents\Work\crossmodel\workloads-realdata\test_var.txt"
    ...
    regular_queries = [remove_stars(i) for i in cross_model_queries]
    sql_queries = rewrite_cm_queries_to_sql(regular_queries, EDGE_RELATION_MAPPING)
    print(len(sql_queries))
    Path(os.path.join(sql_query_dir, "test_var.sql")).write_text(";\n".join(sql_queries))
